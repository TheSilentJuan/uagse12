...
public class Magpie3
{
	...
	public String getResponse(String statement)
	{
		...
		else if(findKeyword(statement, "Destiny") >= 0)
		{
			response = "It's a great game I play as a warlock.";
		}
		else if(findKeyword(statement, "League of Legends") >= 0)
		{
			response = "It's a fun game but toxic at times."; 
		}
		else if(findKeyword(statement, "Vladimir") >= 0)
		{
			response = "He's Russian";
		}
